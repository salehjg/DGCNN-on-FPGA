...
public:
    ...
    //virtual TensorF* MatAdd(WorkScheduler scheduler, TensorF* inputTn1, TensorF* inputTn2)=0;
    //virtual TensorF* MatSub(WorkScheduler scheduler, TensorF* inputTn1, TensorF* inputTn2)=0;
    //virtual TensorF* MatAddTiled(WorkScheduler scheduler, TensorF* inputTn1, TensorF* inputSmallTn2)=0;
    //virtual TensorF* MatSubTiled(WorkScheduler scheduler, TensorF* inputTn1, TensorF* inputSmallTn2)=0;
    //virtual TensorF* MatAddTiled(WorkScheduler scheduler, TensorF* inputTn1, float scalar)=0;
    //virtual TensorF* MatSubTiled(WorkScheduler scheduler, TensorF* inputTn1, float scalar)=0;
    ...
    //virtual TensorF* Multiply(WorkScheduler scheduler, TensorF* inputTn1, TensorF* inputTn2)=0;
    //virtual TensorF* Divide(WorkScheduler scheduler, TensorF* inputTn1, TensorF* inputTn2)=0;
    //virtual TensorF* MultiplyTiled(WorkScheduler scheduler, TensorF* inputTn1, TensorF* inputTn2)=0;
    //virtual TensorF* DivideTiled(WorkScheduler scheduler, TensorF* inputTn1, TensorF* inputTn2)=0;
