...
#pragma HLS array_partition variable=buff complete dim=0
    ...
    int d0,d1,d2,d3;
    unsigned long d0d1d2d3=dimR0*dimR1*dimR2*dimR3;

    d0=0;d1=0;d2=0;d3=0;
    lastCacheVecIdx1=-1;lastCacheVecIdx2=-1;
    LoopMain: for(unsigned long iter=0; iter<d0d1d2d3; iter++){
#pragma HLS LOOP_TRIPCOUNT min=32768000 max=32768000
#pragma HLS PIPELINE II=1
        ...
        if(outputSubVecIdx==(VecDepth-1) || iter==(d0d1d2d3-1)){
