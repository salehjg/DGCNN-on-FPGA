...
#pragma HLS INTERFACE m_axi port=a offset=slave bundle=gmem0 max_read_burst_length=64 max_write_burst_length=2
#pragma HLS INTERFACE m_axi port=b offset=slave bundle=gmem1 max_read_burst_length=64 max_write_burst_length=2
#pragma HLS INTERFACE m_axi port=e offset=slave bundle=gmem2 max_read_burst_length=64 max_write_burst_length=2
#pragma HLS INTERFACE m_axi port=c offset=slave bundle=gmem3 max_read_burst_length=2 max_write_burst_length=64
