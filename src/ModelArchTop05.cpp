...
void ModelArchTop05::SetModelInput_data(string npy_pcl) {
...
void ModelArchTop05::SetModelInput_labels(string npy_labels) {
...
TensorF* ModelArchTop05::Batchnorm_Forward(WorkScheduler scheduler, TensorF* input, TensorF* gamma, TensorF* beta, TensorF* ema_ave, TensorF* ema_var){
    int rank;
    float bn_decay = 0.5f;
...
TensorF* ModelArchTop05::TransformNet(WorkScheduler scheduler, TensorF* edgeFeatures){
...
/// \param scheduler
/// \return
TensorF* ModelArchTop05::Execute(WorkScheduler scheduler) {
    TensorF* net;
    TensorF* net_BxNx3;
...
TensorI* ModelArchTop05::GetLabels(){
    return input_labels_B;
}

int ModelArchTop05::GetBatchSize(){
    return B;
}
