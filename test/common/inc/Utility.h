...
inline void ReferenceImplementation(CONFIG_DTYPE const *a, CONFIG_DTYPE const *b, CONFIG_DTYPE *c,
                                    const unsigned size_n,
                                    const unsigned size_k,
                                    const unsigned size_m) {
  CallBLAS<CONFIG_DTYPE, OperatorMap, OperatorReduce>(a, b, c, size_n, size_k,
                                                size_m);
}
